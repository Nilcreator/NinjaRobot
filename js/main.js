    ...
    contactForm.addEventListener('submit', (e) => {
        ...
        inputs.forEach(input => {
            ...
            if (!input.value.trim()) {
                ...
                errorMsg.setAttribute('data-lang-key', 'contact_error_required');
            } else {
        ...
        if (emailInput.value.trim() && !emailRegex.test(emailInput.value)) {
            ...
            emailErrorMsg.setAttribute('data-lang-key', 'contact_error_email');
        ...
        if (isValid) {
            ...
            contactForm.reset();
            setTimeout(() => {
                document.getElementById('form-success-msg').classList.add('hidden');
            }, 5000);
        }
    });
